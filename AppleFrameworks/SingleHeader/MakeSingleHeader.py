...
class SingleHeader( object ):
	...
	def __process_foundation_directives( self, header ):
		if header.find("#include "Foundation.hpp"") != -1:
			logging.info( '\tSubstituting <Foundation/Foundation.hpp>...' )
			return header.replace("#include "Foundation.hpp"", self.__process_header( os.path.join( self.__base_path[-1], "../Foundation/Foundation.hpp" ) ) )
		return header
